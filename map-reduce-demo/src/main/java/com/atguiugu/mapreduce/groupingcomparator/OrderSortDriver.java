...
public class OrderSortDriver {
    ...
    public static void main(String[] args) throws Exception, IOException {
        ...
        // 6 设置输入数据和输出数据路径
        FileInputFormat.setInputPaths(job, new Path("map-reduce-demo/file/tmp/shopinfo.txt"));
        FileOutputFormat.setOutputPath(job, new Path("map-reduce-demo/file/tmp/shopinfo_out.txt"));
